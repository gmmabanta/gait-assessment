                ...
                children: <Widget>[
                  ...
                  SingleChildScrollView(
                    ...
                    child:  Container(
                        ...
                        child: Expanded(
                          child: StreamBuilder(
                              stream: FirebaseFirestore.instance.collection('schedule').where('user_id', isEqualTo: widget.uid).where('date', isGreaterThanOrEqualTo: DateTime.now().subtract(Duration(hours: 12))).orderBy('date', descending: true).snapshots(),
